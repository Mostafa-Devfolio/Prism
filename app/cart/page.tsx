...
export default function CartPage() {
  ...
  const EmptyCartView = () => (
    <div className="animate-in fade-in zoom-in-95 flex flex-col items-center justify-center rounded-[3rem] border-2 border-dashed border-gray-200 bg-gray-50/50 py-24 text-center duration-500">
      ...
      <h2 className="mb-3 text-3xl font-black tracking-tight text-gray-900">Your cart is empty</h2>
    ...
    <div className="min-h-screen bg-slate-50 pb-24 font-sans">
      <div className="container mx-auto max-w-7xl px-4 py-10">
        ...
        <div className="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          <div>
            <h1 className="text-3xl font-black tracking-tight text-gray-900 sm:text-4xl">Your Cart</h1>
            <p className="mt-2 font-medium text-gray-500">Review your items and proceed to checkout.</p>
          </div>
